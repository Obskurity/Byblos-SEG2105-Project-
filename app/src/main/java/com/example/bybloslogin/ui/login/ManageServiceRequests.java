...
import java.util.List;
    ...
    public class ManageServiceRequests extends AppCompatActivity {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            description.setText("Tap and Hold on a Service Request to View, Approve, or Reject");
            ...
            btnApprovedServices.setText("VIEW APPROVED REQUESTS");
            btnApprovedServices.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent approvedServicesIntent = new Intent(com.example.bybloslogin.ui.login.ManageServiceRequests.this, ApprovedServiceRequests.class);
                    approvedServicesIntent.putExtra("username",username);
        ...
        public void createRequests(){
            DatabaseReference dR = FirebaseDatabase.getInstance().getReference("users").child(username).child("serviceRequests");
            String id = dR.push().getKey();
//            dR.child(id).setValue("customer1\nserviceA\n2002\n");
//            DatabaseReference dR2 = FirebaseDatabase.getInstance().getReference("users").child(username).child("serviceRequests");
//            String id2 = dR2.push().getKey();
//            dR2.child(id2).setValue("customer2\nserviceB\n2002\n");
        ...
        protected void onStart() {
            ...
            databaseServices = FirebaseDatabase.getInstance().getReference("users").child(username).child("serviceRequests");
...
//        ViewSwitcher viewSwitcher = new ViewSwitcher(ManageServicesActivity.this);
            ...
            for (int i = 0; i < serviceRequest.getFields().size(); i++) {
                ...
                LinearLayout fieldMenu = new LinearLayout(com.example.bybloslogin.ui.login.ManageServiceRequests.this);
                fieldMenu.setOrientation(LinearLayout.HORIZONTAL);

                EditText editField = new EditText(com.example.bybloslogin.ui.login.ManageServiceRequests.this);
                ...
                if (i != 0) {
                    Button btnDeleteField = new Button(com.example.bybloslogin.ui.login.ManageServiceRequests.this);
...
//                LinearLayout editFields = (LinearLayout) dialogView.findViewById(R.id.editFieldLayout);
            ...
            btnAddField.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    EditText field = new EditText(com.example.bybloslogin.ui.login.ManageServiceRequests.this);
        ...
        private void searchServices(String query) {
            ...
            ServiceRequestList servicesAdapter = new ServiceRequestList(com.example.bybloslogin.ui.login.ManageServiceRequests.this, serviceRequestArrayList);
